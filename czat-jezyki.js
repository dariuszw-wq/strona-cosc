...
window.PRC_CZAT_JEZYKI = {
  ...
  pl: {
    ...
    q4: 'Zostaw numer telefonu — bez niego nie oddzwonimy. Odezwiemy się w ciągu maksymalnie trzech dni roboczych. Możesz dopisać też e-mail.',
    q4pole: '+48 500 100 200',
    kontaktZly: 'Podaj proszę numer telefonu — bez niego nie mamy jak się odezwać.',
  ...
  en: {
    ...
    q4: 'Leave a phone number — without it we cannot call you back. We will get in touch within three working days at the latest. You may add an e-mail as well.',
    q4pole: '+48 500 100 200',
    kontaktZly: 'Please leave a phone number — without it we have no way to reach you.',
  ...
  es: {
    ...
    q4: 'Déjanos un número de teléfono: sin él no podemos llamarte. Te responderemos en un plazo máximo de tres días hábiles. Puedes añadir también un correo.',
    q4pole: '+48 500 100 200',
    kontaktZly: 'Déjanos por favor un número de teléfono: sin él no tenemos cómo contactarte.',
  ...
  uk: {
    ...
    q4: 'Залиште номер телефону — без нього ми не зателефонуємо. Відповімо максимум протягом трьох робочих днів. Можете додати також e-mail.',
    q4pole: '+48 500 100 200',
    kontaktZly: 'Залиште, будь ласка, номер телефону — без нього ми не маємо як зв’язатися.',
  ...
  ru: {
    ...
    q4: 'Оставьте номер телефона — без него мы не позвоним. Ответим максимум в течение трёх рабочих дней. Можно добавить и e-mail.',
    q4pole: '+48 500 100 200',
    kontaktZly: 'Оставьте, пожалуйста, номер телефона — без него мы не сможем связаться.',
